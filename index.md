...
The volume of data is rapidly growing in the bioinformatics field. Big data sources are no longer limited to meteorological data, data in astronomy or search-engine logs. With digitization of all processes and the ease of generating billions of sequences, data volumes are also rising in bioinformatics. It is estimated that the rate of generation of genome data exceeds 1 petabyte (10^15) per year, and will reach 1 exabyte (10^18) within the next 5 years.  This rate of growth exceeds that represented by Moore’s law.  This trend in the rate of data production is also balanced by falling computing and sequencing costs, and easier access to resources capable of processing these data through cloud providers such as Amazon Web Service and Google Cloud.
